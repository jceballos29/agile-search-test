...
interface CountryProps extends WithTranslation , UserProfileProps {
    country: CountryItem;
    form: FormInstance<CountryItem>;
}

const CountryCreate: FC<CountryProps> = (props) => {
...
export default withTranslation()(withUserProfile(CountryCreate));
