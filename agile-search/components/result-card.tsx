...
export interface ResultCardProps extends WithTranslation, RouteComponentProps, CacheProps, IdentityProps, UserProfileProps {
  grant: any;
}
...
export default withIdentity(withUserProfile(withCache(withTranslation()(withRouter(ResultCard)))));
